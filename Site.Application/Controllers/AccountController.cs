...
namespace Site.Application.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationTenantManager tenantManager, ApplicationSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.Username, hasher.HashPassword(model.Password), model.RememberMe, shouldLockout: false);
            switch (result)
            {
